...
public class program {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Количество яблок кокоробке: %d, вес коробки: %.1f\n", boxApple1.sizeBox(), boxApple1.getWeight());
        ...
        System.out.printf("Количество апельсинов в коробке: %d, вес коробки: %.1f\n", boxOrange1.sizeBox(), boxOrange1.getWeight());
        ...
        System.out.println(boxApple1.compare(boxOrange1)); // Сравнение коробок
